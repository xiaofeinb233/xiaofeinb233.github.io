...
window.onload=function ()
{
	...
	myplay_pause1.onclick=function()
	{
		...
		if(first_index1==1)
			{
				myau.src="music/车载电台音乐/Grimes _ Lizzy Wizzy - Delicate Weapon.mp3";
			}
		first_index1++;
		pp_index1++;
		if(pp_index1>1){
	...
	myplay_pause2.onclick=function()
	{
		...
		if(first_index2==1)
			{
				myau.src="music/车载电台音乐/Health & Window Weather - Major Crimes.mp3";
			}
		first_index2++;
		pp_index2++;
		if(pp_index2>1){
	...
	myplay_pause10.onclick=function()
	{
		...
		if(first_index10==1)
			{
				myau.src="music/游戏原声带/Olga Jankowska - Never Fade Away (SAMURAI Cover) 00_01_45-00_04_54.mp3";
			}
		first_index10++;
		pp_index10++;
		if(pp_index10>1){
	...
	myload1.onclick=function()
	{
		...
		window.open("music/车载电台音乐/Grimes _ Lizzy Wizzy - Delicate Weapon.mp3");
	}
	...
	myload2.onclick=function()
	{
		...
		window.open("music/车载电台音乐/Health & Window Weather - Major Crimes.mp3");
	}
	...
	myload10.onclick=function()
	{
		...
		window.open("music/游戏原声带/Olga Jankowska - Never Fade Away (SAMURAI Cover) 00_01_45-00_04_54.mp3");
	}
	//download
